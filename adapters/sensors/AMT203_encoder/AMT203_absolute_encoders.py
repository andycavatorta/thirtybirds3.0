...
class AMT203():
  ...
  def spi_write_read(self, chip_select_pin, output_byte):
    ...
    time.sleep(.01)
    received_byte = self.spi.xfer(output_byte, self.speed_hz, 20)
  ...
  def get_position(self, chip_select_pin):
    ...
    print("AMT203 get_position chip_select_pin=",chip_select_pin,"most_significant_byte:",most_significant_byte, "least_significant_byte:",least_significant_byte,"two_bytes:",two_bytes)
